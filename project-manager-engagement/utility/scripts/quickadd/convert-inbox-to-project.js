...
module.exports = async (params) => {
  ...
  // Get engagement from inbox item
  const inboxCache = app.metadataCache.getFileCache(activeFile);
  const inboxFm = inboxCache?.frontmatter || {};
  const inboxEngagement = inboxFm.engagement || null;
